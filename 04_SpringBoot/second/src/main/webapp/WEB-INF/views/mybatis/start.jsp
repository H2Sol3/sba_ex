...
<h3>
	<ul>
		<li><a href="<%=request.getContextPath() %>/login">로그인하러가기</a></li>
		<li><a href="<%=request.getContextPath() %>/logout">로그아웃하러가기</a></li>
		<li><a href="<%=request.getContextPath() %>/mybatismemberlist">회원리스트 보러가기(로그인필요없음)</a></li>
		<li><a href="<%=request.getContextPath() %>/memberinsert">회원가입하러가기(로그인필요없음)</a></li>
...
%>
<h1>${!empty updateresult?updateresult:""}</h1>
</body>
</html>