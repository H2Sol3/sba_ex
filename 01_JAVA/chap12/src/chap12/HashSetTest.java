...
public class HashSetTest {
	public static void main(String[] args) {
		...
		HashSet<Integer> set = new HashSet<Integer>(5); // 뒤에 숫자는 의미 없음. 항상 변동 가능함. 일단 시작은 이 정도로 할게~ 라는 의미임
		set.add(1);
		set.add(2);
		set.add(3);
		set.add(4);
		...
		System.out.println("=============================");
		HashSet<Integer> lottoSet = new HashSet<Integer>(6);
		...
		// 방법 1.
		Iterator<Integer> it = lottoSet.iterator(); // 조회만 가능
